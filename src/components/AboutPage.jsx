  ...
  return (
    ...
    <div className="about-content">
      <div className="about-card">
        ...
        <p>
          The OAU Campus Navigator is a comprehensive digital solution designed
          to help students, especially freshers and direct-entry students,
          navigate the expansive Obafemi Awolowo University campus with ease and
          confidence.
        </p>
        ...
        <p>
          ...
          campus facilities, ensuring every student can focus on their academic
          journey rather than worrying about getting lost on campus.
        </p>
